...
public class ViewAddRemoveRoles {
	...
	*/
	...
	// This alert is used when a role change is refused (e.g., removing the last Admin)
	protected static Alert alertRoleChangeRefused = new Alert(AlertType.INFORMATION);
