...
public class ViewMultipleRoleDispatch {
	...
	public static void displayMultipleRoleDispatch(Stage ps, User user) {
		...
		if (theDatabase.getCurrentCuratorRole()) list.add("Curator");
