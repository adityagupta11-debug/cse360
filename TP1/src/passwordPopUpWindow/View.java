...
public class View {
	...
	//added label for "under 20 characters long" - Joshua Luther
	...
	public static void view (Pane theRoot) {
		double windowWidth = PasswordPopupWindow.WINDOW_WIDTH;
	    ...
	    //setupLabelWidget added for ShortEnough
		...
		//modified validPassword test to be lower down in popup
		...
		//Joshua luther: added label_ShortEnough
