...
public class ViewViewerHome {
	...
	private ViewViewerHome() {
        ...
        button_UpdateThisUser.setOnAction((ignoredEvent) -> {ControllerViewerHome.performUpdate(); });
        ...
        button_Logout.setOnAction((ignoredEvent) -> {ControllerViewerHome.performLogout(); });
        
        setupButtonUI(button_Quit, "Dialog", 18, 250, Pos.CENTER, 300, 540);
        button_Quit.setOnAction((ignoredEvent) -> {ControllerViewerHome.performQuit(); });
